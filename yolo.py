...
# Use this file need to call function: yoloscore()
# need to change the default video path into the video path(line 71)
# change total_count followed by instruction (line 235-239)
...
parser.add_argument(
    ...
    #required=True,
    default= '/Users/vincentzhao/Desktop/ImageCW/l2-ip-assignment/cvhm34的副本/project.avi')
parser.add_argument(
    "-cl",
    "--class_file",
    type=str,
    help="list of classes",
    default='//Users/vincentzhao/Desktop/ImageCW/l2-ip-assignment/cvhm34的副本/coco.names')
parser.add_argument(
    "-cf",
    "--config_file",
    type=str,
    help="network config",
    default='/Users/vincentzhao/Desktop/ImageCW/l2-ip-assignment/cvhm34的副本/yolov3.cfg')
parser.add_argument(
    "-w",
    "--weights_file",
    type=str,
    help="network weights",
    default='/Users/vincentzhao/Desktop/ImageCW/l2-ip-assignment/cvhm34的副本/yolov3.weights')
...
def yoloscore():
    ...
    output_video_file_name = '/Users/vincentzhao/Desktop/ImageCW/l2-ip-assignment/cvhm34/Results/output_video.avi'
